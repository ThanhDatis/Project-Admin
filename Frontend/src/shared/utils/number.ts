...
export const formatInteger = (value: number | string | null | undefined): string => {
  ...
  if (isNaN(numValue)) return '-';
  return new Intl.NumberFormat('vi-VN', { maximumFractionDigits: 0 }).format(numValue);
};
 ...
 */
export const formatWithUnit = (value: number | string | null | undefined, unit: string): string => {
  if (value == null || value === '') return '-';
...
// DataGrid wrappers
export const formatNumberGrid = (params: { value: any }): string => formatNumber(params.value);
export const formatIntegerGrid = (params: { value: any }): string => formatInteger(params.value);
...
export const formatCompactGrid = (params: { value: any }): string => formatCompact(params.value);
...
export const formatters = {
  ...
  quantity: (value: number | string | null | undefined) => formatWithUnit(value, 'cái'),
  weight: (value: number | string | null | undefined) => formatWithUnit(value, 'kg'),
  distance: (value: number | string | null | undefined) => formatWithUnit(value, 'km'),
};
